      ...
      <View style={styles.userDetailContainer}>
        ...
        <ScrollView style={styles.userDetailContent}>
          <View style={styles.userInfoCard}>
            ...
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>शेवटचे लॉगिन स्थान:</Text>
              <Text style={styles.statusValue}>{formatLocationString(selectedUser.lastLoginLocation)}</Text>
            </View>
            ...
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>शेवटचे लॉगआउट स्थान:</Text>
              <Text style={styles.statusValue}>{formatLocationString(selectedUser.lastLogoutLocation)}</Text>
            </View>
          </View>
                ...
                <View key={session.id || index} style={styles.sessionItem}>
                  ...
                  {session.loginLocation && (
                    <Text style={styles.sessionLocation}>
                      लॉगिन स्थान: {formatLocationString(session.loginLocation)}
                    </Text>
                  )}
                  {session.logoutTime && (
                  ...
                  {session.logoutLocation && (
                    <Text style={styles.sessionLocation}>
                      लॉगआउट स्थान: {formatLocationString(session.logoutLocation)}
                    </Text>
                  )}
                  {session.logoutTime && (
