...
const VoterDetailScreen = ({ route, navigation }) => {
        ...
        const updateUserActionCount = async (actionType) => {
                try {
                        const sessionDataRaw = await AsyncStorage.getItem("session")
                        ...
                        sessionMetrics[actionType] = (sessionMetrics[actionType] || 0) + 1
                        ...
                        userMetrics[`total_${actionType}`] = (userMetrics[`total_${actionType}`] || 0) + 1
        ...
        const saveVoterDetails = async () => {
                ...
                setSaving(true)
                try {
                        // Update local state only since we're using local dataset
                        const updatedVoter = {
                                ...currentVoter,
                                "मोबाईल_नंबर": mobileNumber,
                                "पत्ता": address,
                        }
        ...
        const downloadSlip = async () => {
                ...
                try {
                        ...
                        if (status !== "granted") {
                                Alert.alert("परवानगी आवश्यक", "फोटो सेव्ह करण्यासाठी परवानगी द्या")
                                setIsDownloading(false)
                                return
                        }

                        // Capture the slip view
                        ...
                        if (Platform.OS === "android") {
                                ...
                                // For iOS, copy to documents directory and share
                        ...
                        Alert.alert("त्रुटी", "स्लिप डाउनलोड करताना समस्या आली: " + error.message)
                } finally {
                        setIsDownloading(false)
                }
        }
        ...
        const getParentName = () => {
                if (currentVoter["वडिलांचे_नाव"]) {
                        return `पिता: ${currentVoter["वडिलांचे_नाव"]}`
                } else if (currentVoter["पतीचे_नाव"]) {
                        return `पती: ${currentVoter["पतीचे_नाव"]}`
                }
                return ""
        }
        ...
        return (
                <SafeAreaView style={styles.container}>
                        <View style={styles.header}>
                                ...
                                <TouchableOpacity onPress={downloadSlip} disabled={isDownloading} style={styles.downloadButton}>
                                        {isDownloading ? (
                                ...
                                <View style={styles.voterCard}>
                                        ...
                                        <View style={styles.voterInfo}>
                                                <View style={styles.avatarContainer}>
                                                        <Image source={require("../assets/profile-placeholder.png")} style={styles.voterAvatar} />
                                        ...
                                        <View style={styles.detailsGrid}>
                                                <View style={styles.detailRow}>
                                                        <View style={styles.detailItem}>
                                                                ...
                                                                <Text style={styles.detailValue}>{currentVoter["नाव"] || currentVoter["मतदाराचे_पूर्ण_नांव"]}</Text>
                                                        </View>
                                                        <View style={styles.detailItem}>
                                                                <Text style={styles.detailLabel}>पत्ता</Text>
                                                                <Text style={styles.detailValue}>{address || currentVoter["पत्ता"] || "N/A"}</Text>
                                                        </View>
                                                </View>
                                        ...
                                        <View style={styles.slipPreviewContainer}>
                                                ...
                                                <View style={styles.slipPreviewContent}>
                                                        <View style={styles.slipPreviewRow}>
                                                                ...
                                                                <Text style={styles.slipPreviewValue}>{currentVoter["नाव"] || currentVoter["मतदाराचे_पूर्ण_नांव"]}</Text>
                                                        </View>
                                                        ...
                                                        <View style={styles.slipPreviewRow}>
                                                                ...
                                                                <Text style={styles.slipPreviewValue}>{address || currentVoter["पत्ता"] || "N/A"}</Text>
                                                        </View>
                                                ...
                                                <View style={styles.slipPreviewFooter}>
                                                        <Text style={styles.slipPreviewFooterText}>मतदान व्यवस्थापन प्रणाली</Text>
                                        ...
                                        <View ref={slipRef} style={styles.slipContainer} collapsable={false}>
                                                ...
                                                <View style={styles.slipContent}>
                                                        <View style={styles.slipInfoRow}>
                                                                ...
                                                                <Text style={styles.slipValue}>{currentVoter["नाव"] || currentVoter["मतदाराचे_पूर्ण_नांव"]}</Text>
                                                        </View>
                                                        ...
                                                        <View style={styles.slipInfoRow}>
                                                                ...
                                                                <Text style={styles.slipValue}>{address || currentVoter["पत्ता"] || "N/A"}</Text>
                                                        </View>
                                                        ...
                                                        <View style={styles.slipFooter}>
                                                                <Text style={styles.slipFooterText}>मतदान व्यवस्थापन प्रणाली</Text>
