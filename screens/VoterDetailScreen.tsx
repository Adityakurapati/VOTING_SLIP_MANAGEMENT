  ...
  const saveVoterDetails = async () => {
    ...
    try {
      ...
      if (Object.keys(updates).length > 0) {
        const voterRef = ref(
          database,
          `villages/${currentVoter.village}/${currentVoter.division}/${currentVoter.vibhag}/मतदार_यादी/${currentVoter.firebaseKey}`,
        )
          ...
          <View ref={slipRef} style={styles.slipContainer} collapsable={false}>
            ...
            <View style={styles.slipContent}>
              <View style={styles.slipInfoRow}>
                ...
                <Text style={styles.slipValue}>{currentVoter["नाव"]}</Text>
              </View>
