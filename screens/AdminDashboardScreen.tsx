                                ...
                                <View style={styles.sessionDetailContent}>
                                        ...
                                        <ScrollView style={styles.sessionDetailScroll}>
                                                ...
                                                {selectedSession.sections && (
                                                        <>
                                                                <View style={[styles.sessionDetailInfo, { marginTop: 16, borderTopWidth: 1, borderTopColor: '#eee', paddingTop: 16 }]}>
                                                                        <Text style={[styles.sessionDetailLabel, { fontWeight: 'bold', fontSize: 16 }]}>विभागनिहाय तपशील:</Text>
                                                                </View>

                                                                {Object.entries(selectedSession.sections).map(([villageKey, divisions]: any) => (
                                                                        <View key={villageKey} style={{ marginBottom: 16 }}>
                                                                                <Text style={[styles.sessionDetailLabel, { fontWeight: 'bold', fontSize: 15, color: '#2196F3' }]}>
                                                                                        गाव: {villageKey}
                                                                                </Text>

                                                                                {divisions && Object.entries(divisions as any).map(([divisionKey, vibhags]: any) => (
                                                                                        <View key={divisionKey} style={{ marginLeft: 8, marginTop: 8 }}>
                                                                                                <Text style={[styles.sessionDetailLabel, { fontWeight: '600', fontSize: 14, color: '#333' }]}>
                                                                                                        भाग: {divisionKey}
                                                                                                </Text>

                                                                                                {vibhags && Object.entries(vibhags as any).map(([vibhagKey, counts]: any) => (
                                                                                                        <View key={vibhagKey} style={{
                                                                                                                marginLeft: 12,
                                                                                                                marginTop: 6,
                                                                                                                ...
                                                                                                                <Text style={[styles.sessionDetailValue, { fontSize: 13 }]}>
                                                                                                                        <Text style={{ fontWeight: '500' }}>विभाग: {vibhagKey}</Text>
                                                                                                                        {"\n"}
                                                                                                                        स्लिप: {Number((counts as any).slips_issued || 0)}
                                                                                                                        {" • "}
                                                                                                                        मतदान: {Number((counts as any).voting_done || 0)}
                                                                                                                </Text>
                                                                                                        </View>
                                                                                                ))}
                                                                                        </View>
